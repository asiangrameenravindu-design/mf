...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Loan Settings - Fixed database version
                            ...
                            <form method="POST" action="">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="company_name" class="form-control" value="<?php echo $current_settings['company_name']; ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea name="company_address" class="form-control" rows="3" required><?php echo $current_settings['company_address']; ?></textarea>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Company Phone *</label>
                                        <input type="tel" name="company_phone" class="form-control" value="<?php echo $current_settings['company_phone']; ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Company Email *</label>
                                        <input type="email" name="company_email" class="form-control" value="<?php echo $current_settings['company_email']; ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                            ...
                            <form method="POST" action="">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="smtp_host" class="form-control" value="<?php echo $current_settings['smtp_host']; ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="smtp_username" class="form-control" value="<?php echo $current_settings['smtp_username']; ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">SMTP Password *</label>
                                        <div class="input-group">
                                            <input type="password" name="smtp_password" class="form-control" id="smtpPassword" value="<?php echo $current_settings['smtp_password']; ?>" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" name="from_email" class="form-control" value="<?php echo $current_settings['from_email']; ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">From Name *</label>
                                        <input type="text" name="from_name" class="form-control" value="<?php echo $current_settings['from_name']; ?>" required>
                                    </div>
                                </div>
                                <div class="mt-3">
