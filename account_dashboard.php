...
// Active Loans
$sql = "SELECT COUNT(*) as total FROM loans WHERE status IN ('active', 'disbursed')";
$result = $conn->query($sql);
if ($result) {
...
// Total Loan Amount
$sql = "SELECT SUM(amount) as total FROM loans WHERE status IN ('active', 'disbursed')";
$result = $conn->query($sql);
if ($result) {
...
$collection_rate = 92; // Sample collection rate
?>
            ...
            <div class="row g-4">
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="stat-card warning animate__animated animate__fadeInUp animate__delay-2s">
                                <div class="position-relative">
                                    <h2 class="display-4 fw-bold mb-0">Rs. <?php echo number_format($total_loan_amount, 2); ?></h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="text-center p-4 bg-light rounded h-100 d-flex flex-column justify-content-center">
                                    <h3 class="text-primary fw-bold"><?php echo number_format($pending_loans); ?></h3>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="glass-card p-4 animate__animated animate__fadeInRight animate__delay-1s">
                        <h4 class="fw-bold text-dark mb-4">
                            <i class="bi bi-hdd-stack me-2 text-info"></i>System Status
                        </h4>
                        <div class="row text-center">
                            <div class="col-6 mb-3">
                                <div class="p-3 bg-success bg-opacity-10 rounded">
                                    <i class="bi bi-database text-success display-6"></i>
                                    <p class="mb-0 mt-2 fw-bold">Database</p>
                                    <small class="text-success">Online</small>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="p-3 bg-primary bg-opacity-10 rounded">
                                    <i class="bi bi-server text-primary display-6"></i>
                                    <p class="mb-0 mt-2 fw-bold">Server</p>
                        ...
                        <div class="mt-3 p-3 bg-light rounded">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="fw-bold text-dark"><?php echo date('M j, g:i A'); ?></span>
                            </div>
